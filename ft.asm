...
; LN:2 dim x as long
x rd 1
; LN:3 dim p(8) as long
align 4
p rd 8
; LN:4 type havis
; LN:8 dim q(10) as havis
align 4
q rb 20
; LN:9 dim r as havis
align 4
...
OBMain_CREATE:
; LN:12 open "testfile" for scratch as tf
mov esi,_StrConst1
mov [_TmpVec1],esi
mov [_TmpVec1+4],9
mov [_TmpVec1+8],0
...
; LN:13 put tf,p; whole array of longs
mov eax, dword [tf]
mov [_IOPthNum],eax
mov esi,p
mov [_XferAddr],esi
...
jmp [_ErrVec]
_OELbl2:
; LN:14 put tf,p(3); 3rd element of array of longs
mov eax, dword [tf]
mov [_IOPthNum],eax
mov esi,p-(1*4)
mov eax,3
...
jmp [_ErrVec]
_OELbl3:
; LN:15 put tf,q; whole array of types
mov eax, dword [tf]
mov [_IOPthNum],eax
mov esi,q
mov [_TmpVec1],esi
...
jmp [_ErrVec]
_OELbl4:
; LN:16 put tf,q(5); 5th element of array of types
mov eax, dword [tf]
mov [_IOPthNum],eax
mov esi,q
mov eax,5
...
jmp [_ErrVec]
_OELbl5:
; LN:17 put tf,x; simple var (long)
mov eax, dword [tf]
mov [_IOPthNum],eax
mov esi,x
mov [_XferAddr],esi
