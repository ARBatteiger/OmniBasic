...
_StrConst3 db "Button1",0
_StrConst4 db "Button1",0
...
!OBMain rd 192
; LN:3 DIM Button(4) AS BUTTON
!Button rd 768
; LN:3 DIM TextBox1 AS TEXTBOX
!TextBox1 rd 192
...
mov esi,!Button
_Lbl6:
mov dword [esi+104],Button_CLICK
mov dword [esi+104+4],0
add esi,768
dec ecx
jne _Lbl6
mov [!TextBox1+104],TextBox1_GOTFOCUS
mov [!TextBox1+104+4],256
ret
; End of Init Section
...
; LN:3 CREATE Button(1),20,20,80,20
mov edi,!Button-768
mov eax,1
mov [_ArgSafe6],eax
imul eax,768
...
mov edi,[!TargetGUIDesc]
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_IOBuffer]
; LN:3 CREATE Button(2),20,50,80,20
mov edi,!Button-768
mov eax,2
mov [_ArgSafe6],eax
imul eax,768
...
mov edi,[!TargetGUIDesc]
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_IOBuffer]
; LN:3 CREATE Button(3),20,80,80,20
mov edi,!Button-768
mov eax,3
mov [_ArgSafe6],eax
imul eax,768
...
mov edi,[!TargetGUIDesc]
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_IOBuffer]
; LN:3 CREATE Button(4),20,110,80,20
mov edi,!Button-768
mov eax,4
mov [_ArgSafe6],eax
imul eax,768
...
mov edi,[!TargetGUIDesc]
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_IOBuffer]
; LN:3 CREATE TextBox1,130,20,70,20
mov edi,!TextBox1
mov [!TargetGUIDesc],edi
mov eax,130
mov dword [edi+LeftOffs],eax
...
mov edi,[!TargetGUIDesc]
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_IOBuffer]
; LN:3 TextBox1.BACKCOLOR=$ffffff
mov edi,!TextBox1
mov [!TargetGUIDesc],edi
mov eax,16777215
...
mov [ArrayIndex],eax
; LN:8 .ArrayIndex
; LN:9 TextBox1.text=str(ArrayIndex)
mov edi,!TextBox1
mov [!TargetGUIDesc],edi
