...
!ControlType41 db 'OBButton',0
!ControlType42 db 'OBCanvas',0
!ControlType43 db 'MyControl3',0
!ControlType44 db 'MyControl4',0
!ControlType45 db 'MyControl5',0
!ControlType46 db 'MyControl6',0
!ControlType47 db 'MyControl7',0
!ControlType48 db 'MyControl8',0
!ControlType49 db 'MyControl9',0
!ControlType50 db 'MyControl10',0
!ControlType51 db 'MENU_BUTTON',0

!OBMainWindowClass WNDCLASSEX
msg MSG
...
_StrConst2 db "Text1",0
_StrConst3 db "Text1",0
_StrConst4 db "Text1",0
_StrConst5 db "Button1",0
!ObjectCount dd 5
...
!CT_OBButton equ 140
!CT_OBCanvas equ 141
!CT_MyControl3 equ 142
!CT_MyControl4 equ 143
!CT_MyControl5 equ 144
!CT_MyControl6 equ 145
!CT_MyControl7 equ 146
!CT_MyControl8 equ 147
!CT_MyControl9 equ 148
!CT_MyControl10 equ 149
!CT_MENU_BUTTON equ 150
...
!OBMain rd 192
; LN:3 DIM Text1 AS TEXTBOX
!Text1 rd 192
; LN:3 DIM Text2 AS TEXTBOX
!Text2 rd 192
; LN:3 DIM Text3 AS TEXTBOX
!Text3 rd 192
...
mov [!OBMainWindowClass.cbSize],48	
invoke LoadIcon,0,IDI_APPLICATION
mov [!OBMainWindowClass.hIcon],eax
mov [!OBMainWindowClass.hIconSm],eax
...
invoke RegisterClassEx,!OBMainWindowClass
...
; LN:3 CREATE Text1,10,10,60,20 TEXT="Text1"
mov edi,!Text1
mov [!TargetGUIDesc],edi
mov eax,10
mov dword [edi+LeftOffs],eax
...
mov [_TmpVec1+8],0
call __SetRightBottom
invoke CreateWindowEx,WS_EX_CLIENTEDGE,!ControlType5,[_TmpVec1],$50000000, dword [edi+LeftOffs], dword [edi+TopOffs], dword [edi+WidthOffs], dword [edi+HeightOffs], dword [!OBMain],101,[hInstance],0
...
; LN:3 CREATE Text2,80,10,60,20 TEXT="Text1"
mov edi,!Text2
mov [!TargetGUIDesc],edi
mov eax,80
mov dword [edi+LeftOffs],eax
...
mov [_TmpVec1+8],0
call __SetRightBottom
invoke CreateWindowEx,WS_EX_CLIENTEDGE,!ControlType5,[_TmpVec1],$50000000, dword [edi+LeftOffs], dword [edi+TopOffs], dword [edi+WidthOffs], dword [edi+HeightOffs], dword [!OBMain],102,[hInstance],0
mov dword [edi+HandleOffs],eax
invoke SetWindowLong, dword eax,GWL_USERDATA,edi
mov dword [edi+TTcbSizeOffs],44
mov eax,[_ArgSafe3]
...
invoke GetWindowLong,dword [edi+HandleOffs],GWL_WNDPROC
mov dword [edi+InterceptSafeOffs],eax
; LN:3 CREATE Text3,150,10,60,20 TEXT="Text1"
mov edi,!Text3
mov [!TargetGUIDesc],edi
mov eax,150
mov dword [edi+LeftOffs],eax
...
mov [_TmpVec1+8],0
call __SetRightBottom
invoke CreateWindowEx,WS_EX_CLIENTEDGE,!ControlType5,[_TmpVec1],$50000000, dword [edi+LeftOffs], dword [edi+TopOffs], dword [edi+WidthOffs], dword [edi+HeightOffs], dword [!OBMain],103,[hInstance],0
mov dword [edi+HandleOffs],eax
invoke SetWindowLong, dword eax,GWL_USERDATA,edi
mov dword [edi+TTcbSizeOffs],44
mov eax,[_ArgSafe3]
...
invoke GetWindowLong,dword [edi+HandleOffs],GWL_WNDPROC
mov dword [edi+InterceptSafeOffs],eax
; LN:3 CREATE Button1,10,40,200,20 TEXT="Button1"
mov edi,!Button1
mov [!TargetGUIDesc],edi
mov eax,10
mov dword [edi+LeftOffs],eax
...
mov [_TmpVec1+8],0
call __SetRightBottom
invoke CreateWindowEx,0,!ControlType2,[_TmpVec1],$50000001, dword [edi+LeftOffs], dword [edi+TopOffs], dword [edi+WidthOffs], dword [edi+HeightOffs], dword [!OBMain],104,[hInstance],0
mov dword [edi+HandleOffs],eax
invoke SetWindowLong, dword eax,GWL_USERDATA,edi
mov dword [edi+TTcbSizeOffs],44
mov eax,[_ArgSafe3]
...
mov [!TargetGUIDesc],edi
Button1_CLICK:
; LN:8 if Text1.text=Text2.text and Text2.text=Text3.text then
mov edi,!Text1
mov [!SourceGUIDesc],edi
invoke SendMessage, dword [edi+HandleOffs],WM_GETTEXT,_BufSize,[_IOBuffer]
mov edi,!Text2
mov [!SourceGUIDesc],edi
invoke SendMessage, dword [edi+HandleOffs],WM_GETTEXT,_BufSize,[_PrintBuf]
mov edi,_IOBuffer
mov esi,_PrintBuf
call __CmpStr
sete bl
...
__SendMessage:
mov edx,[!TargetGUIDesc]
invoke SendMessage,dword [edx],ecx,ebx,eax
mov [STATUS],eax
ret
