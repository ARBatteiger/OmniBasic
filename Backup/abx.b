...
CONST ExpTabSiz=300
CONST UserSym=302'  set to first user symbol in PreDefined
...
DIM ObjectParentName AS STRING*28
...
TABLE FormPropTable AS PropData
 "status",pgStatus,psBad,LONGVAR
 "id",pgID,psBad,LONGVAR
 "handle",pgHandle,psBad,LONGVAR
...
TABLE ComboBoxPropTable AS PropData
 ...
 "selitem",pgComboBoxSelItem,psComboBoxSelItem,LONGVAR
 "topitem",pgComboBoxTopItem,psComboBoxTopItem,LONGVAR
 "seltext",pgComboBoxSelText,psBad,STRINGVAR
 "%",MainLoop,MainLoop,0
ENDTABLE
...
TABLE ListBoxPropTable AS PropData
 ...
 "selitem",pgListBoxSelItem,psListBoxSelItem,LONGVAR
 "topitem",pgListBoxTopItem,psListBoxTopItem,LONGVAR
 "seltext",pgListBoxSelText,psBad,STRINGVAR
 "%",MainLoop,MainLoop,0
ENDTABLE
...
TABLE TimerPropTable AS PropData
 "interval",pgBad,psInterval,LONGVAR
...
TABLE RichEditPropTable AS PropData
 ...
 "visible",pgVisible,psVisible,BOOLVAR
 "enabled",pgEnabled,psEnabled,BOOLVAR
 "backcolor",pgBackColor,psRichEditBackColor,LONGVAR
 "forecolor",pgForeColor,psForeColor,LONGVAR
 "left",pgLeft,psLeft,LONGVAR
 "top",pgTop,psTop,LONGVAR
 "width",pgWidth,psWidth,LONGVAR
...
TABLE ScintillaPropTable AS PropData
 "status",pgStatus,psBad,LONGVAR
 "id",pgID,psBad,LONGVAR
 "handle",pgHandle,psBad,LONGVAR
 "visible",pgVisible,psVisible,BOOLVAR
 ...
 "width",pgWidth,psWidth,LONGVAR
 "height",pgHeight,psHeight,LONGVAR
 "text",pgSciText,psSciText,STRINGVAR
 "loadfile",pfSciLoadFile,pfSciLoadFile,LONGVAR
 "savefile",pfSciSaveFile,pfSciSaveFile,LONGVAR
 "clear",pfSciClear,pfSciClear,LONGVAR
 "addtext",pgBad,psSciAddText,STRINGVAR
 "hscroll",pgSciHScroll,psSciHScroll,BOOLVAR
 "%",MainLoop,MainLoop,0
ENDTABLE

TABLE ScintillaStyleTable AS StyleData
 "flat",0,EXSTYLE
 "3d",$200,EXSTYLE
 "%",0,0
ENDTABLE

TABLE ScintillaEventTable AS EventData
 "command",evCommandUsed,evCommandOffs,0
 "%",0,0,0
ENDTABLE
...
TABLE ObjTable AS ObjData
 ...
 0,COMCTL,"richedit","RICHEDIT20A","WS_EX_CLIENTEDGE","WS_VISIBLE+WS_CHILD+ES_MULTILINE+WS_VSCROLL+WS_HSCROLL+ES_NOHIDESEL",80,30,RichEditPropTable,RichEditStyleTable,RichEditEventTable
 0,COMCTL,"scintilla","Scintilla","WS_EX_CLIENTEDGE","WS_CHILD+WS_VISIBLE+WS_TABSTOP",80,30,ScintillaPropTable,ScintillaStyleTable,ScintillaEventTable
ENDTABLE
...
IF GUIFlag<>0 THEN
	...
	GOSUB OutInitData
	OutBuf="!Scintilla db 'SciLexer.dll',0"
	GOSUB OutInitData
	...
	GOSUB OutInitData
	OutBuf="fr_lpstrReplaceWith dd 0"
	GOSUB OutInitData
...
ENDIF
INC LabelNum
OutBuf="bt dword [edi+"+STR$(StatusOffs)+"],0"
GOSUB OutCodeData
...
IF ObjectTypeSafe=4 THEN' ComboBox
	OutBuf="mov dword edi,[!TargetGUIDesc]"
	GOSUB OutCodeData	
...
IF InFlag=TRUE THEN
	IF LAND(SymTable(SymNdx).DataMod,SubClassedBit)=0 THEN
		...
		INC SCLabelNum
		OutBuf="bts dword ["+ObjectParentName+"],6"
		GOSUB OutCodeData
...
IF GUIArrayFlag=0 THEN
	OutBuf="mov dword [edi+"+STR$(ArrayOffs)+"],0"
	GOSUB OutCodeData
	OutBuf="mov dword [edi+"+STR$(StatusOffs)+"],$07"
ELSE
	OutBuf="mov eax,[ArrayIndex]"
	GOSUB OutCodeData
	OutBuf="mov dword [edi+"+STR$(ArrayOffs)+"],eax"
	GOSUB OutCodeData
	OutBuf="mov dword [edi+"+STR$(StatusOffs)+"],$27"
ENDIF
GOSUB OutCodeData
...
GOSUB OutCodeData
IF ObjectTypeSafe=22 THEN'Scintilla
	OutBuf="invoke SendMessage, dword [edi+44],2242,1,0"
	GOSUB OutCodeData
	OutBuf="invoke SendMessage, dword [edi+44],2130,0,0"
	GOSUB OutCodeData
ENDIF
OutBuf="_Lbl"+STR$(LabelNum)+":"
GOSUB OutCodeData
...
GOSUB OutCodeData
OutBuf="btc dword [edi],0"
GOSUB OutCodeData
OutBuf="btc dword ["+HandleName+"],6"
GOSUB OutCodeData
OutBuf="_Lbl"+STR$(LabelNum)+":"
GOSUB OutCodeData
GOTO MainLoop
...
GOSUB OutCodeData
IF OpenSave=0 THEN
	OutBuf="mov [ofn_Flags],OFN_EXPLORER+OFN_FILEMUSTEXIST+OFN_FILEMUSTEXIST+OFN_HIDEREADONLY"
	GOSUB OutCodeData
...
DATA "ofn_lStructSize,LONGVAR,0,0,0,4"
DATA "ofn_hwndOwner,LONGVAR,0,0,0,4"
DATA "ofn_hInstance,LONGVAR,0,0,0,4"
DATA "ofn_lpstrFilter,LONGVAR,0,0,0,4"
DATA "ofn_lpstrCustomFilter,LONGVAR,0,0,0,4"
DATA "ofn_nFilterIndex,LONGVAR,0,0,0,4"
DATA "ofn_lpstrFile,LONGVAR,0,0,0,4"
DATA "ofn_nMaxFile,LONGVAR,0,0,0,4"
DATA "ofn_nMaxFileTitle,LONGVAR,0,0,0,4"
DATA "ofn_lpstrTitle,LONGVAR,0,0,0,4"
DATA "ofn_Flags,LONGVAR,0,0,0,4"
DATA "ofn_nFileOffset,WORDVAR,0,0,0,2"
DATA "ofn_nFileExtension,WORDVAR,0,0,0,2"
DATA "ofn_lpstrDefExt,LONGVAR,0,0,0,4"
DATA "ofn_lCustData,LONGVAR,0,0,0,4"
DATA "ofn_lpfnHook,LONGVAR,0,0,0,4"
DATA "ofn_lpTemplateName,LONGVAR,0,0,0,4"
DATA "cc_lStructSize,LONGVAR,0,0,0,4"
DATA "cc_hwndOwner,LONGVAR,0,0,0,4"
DATA "cc_hInstance,LONGVAR,0,0,0,4"
DATA "cc_rgbResult,LONGVAR,0,0,0,4"
DATA "cc_lpCustColors,LONGVAR,0,0,0,4"
DATA "cc_Flags,LONGVAR,0,0,0,4"
DATA "cc_lCustData,LONGVAR,0,0,0,4"
DATA "cc_lpfnHook,LONGVAR,0,0,0,4"
DATA "cc_lpTemplateName,LONGVAR,0,0,0,4"
DATA "fr_lStructSize,LONGVAR,0,0,0,4"
DATA "fr_hwndOwner,LONGVAR,0,0,0,4"
DATA "fr_hInstance,LONGVAR,0,0,0,4"
DATA "fr_Flags,LONGVAR,0,0,0,4"
DATA "fr_lpstrFindWhat,LONGVAR,0,0,0,4"
DATA "fr_lpstrReplaceWith,LONGVAR,0,0,0,4"
DATA "fr_wFindWhatLen,WORDVAR,0,0,0,2"
DATA "fr_wReplaceWithLen,WORDVAR,0,0,0,2"
DATA "fr_lCustData,LONGVAR,0,0,0,4"
DATA "fr_lpfnHook,LONGVAR,0,0,0,4"
DATA "fr_lpTemplateName,LONGVAR,0,0,0,4"
DATA "cf_lStructSize,LONGVAR,0,0,0,4"
DATA "cf_hwndOwner,LONGVAR,0,0,0,4"
DATA "cf_hDC,LONGVAR,0,0,0,4"
DATA "cf_lpLogFont,LONGVAR,0,0,0,4"
DATA "cf_iPointSize,LONGVAR,0,0,0,4"
DATA "cf_Flags,LONGVAR,0,0,0,4"
DATA "cf_rgbColors,LONGVAR,0,0,0,4"
DATA "cf_lCustData,LONGVAR,0,0,0,4"
DATA "cf_lpfnHook,LONGVAR,0,0,0,4"
DATA "cf_lpTemplateName,LONGVAR,0,0,0,4"
DATA "cf_hInstance,LONGVAR,0,0,0,4"
DATA "cf_lpszStyle,LONGVAR,0,0,0,4"
DATA "cf_nFontType,WORDVAR,0,0,0,2"
DATA "cf_wReserved,WORDVAR,0,0,0,2"
DATA "cf_nSizeMin,LONGVAR,0,0,0,4"
DATA "cf_nSizeMax,LONGVAR,0,0,0,4"
DATA "pr_lStructSize,LONGVAR,0,0,0,4"
DATA "pr_hwndOwner,LONGVAR,0,0,0,4"
DATA "pr_hDevMode,LONGVAR,0,0,0,4"
DATA "pr_hDevNames,LONGVAR,0,0,0,4"
DATA "pr_hDC,LONGVAR,0,0,0,4"
DATA "pr_Flags,LONGVAR,0,0,0,4"
DATA "pr_nFromPage,WORDVAR,0,0,0,2"
DATA "pr_nToPage,WORDVAR,0,0,0,2"
DATA "pr_nMinPage,WORDVAR,0,0,0,2"
DATA "pr_nMaxPage,WORDVAR,0,0,0,2"
DATA "pr_nCopies,WORDVAR,0,0,0,2"
DATA "pr_hInstance,LONGVAR,0,0,0,4"
DATA "pr_lCustData,LONGVAR,0,0,0,4"
DATA "pr_lpfnPrintHook,LONGVAR,0,0,0,4"
DATA "pr_lpfnSetupHook,LONGVAR,0,0,0,4"
DATA "pr_lpPrintTemplateName,LONGVAR,0,0,0,4"
DATA "pr_lpSetupTemplateName,LONGVAR,0,0,0,4"
DATA "pr_hPrintTemplate,LONGVAR,0,0,0,4"
DATA "pr_hSetupTemplate,LONGVAR,0,0,0,4"
DATA "%"
...
IF DMArray<>0 OR TDataType=COMPLEX THEN
	...
	ELSE
		...
		OutBuf="jne _Lbl"+STR$(LabelNum)
		GOSUB OutInitCode
		TempStr=TempStyle+SymType+STR$(ArraySize/4+1)
	ENDIF
ELSE
	IF TDataSize=2 THEN
		OutBuf="align 2"
	...
	ELSE
		OutBuf="mov ["+TempStyle+"],0"
		GOSUB OutInitCode
		TempStr=TempStyle+SymType+"41"
	ENDIF
ENDIF
OutBuf=TempStr
GOSUB OutDim
...
ELSE
	...
	GOSUB OutInitCode
	IF DescOffs>=88 AND DescOffs<=120 THEN' Sub code for command event
		OutBuf="mov [esi+"+STR$(DescOffs)+"+4],"+STR$(NotifyCode)
		GOSUB OutInitCode
	ENDIF
	OutBuf="add esi,160"
	GOSUB OutInitCode
...
SELECT CASE TokenBuf
	CASE "true"
		TempStr="SW_SHOW"
		OutBuf="bts dword [edi],2"
	CASE "false"
		TempStr="SW_HIDE"
		OutBuf="btc dword [edi],2"
	CASE ELSE
		ErrNo=ErrIVType
		RETURN
END SELECT
...
SELECT CASE TokenBuf
	...
	CASE ELSE
		...
		RETURN
END SELECT
OutBuf="invoke SendMessage, dword ["+HandleName+"],2130,"+TempStr+",0"
GOSUB OutCodeData
RETURN
...
SELECT CASE TokenBuf
	CASE "true"
		TempStr="TRUE"
		OutBuf="bts dword [edi],1"
	CASE "false"
		TempStr="FALSE"
		OutBuf="btc dword [edi],1"
	CASE ELSE
		ErrNo=ErrIVType
		RETURN
END SELECT
...
OutBuf="mov edi,[!TargetGUIDesc]"
GOSUB OutCodeData
OutBuf="bts dword [edi+"+STR$(StatusOffs)+"],3"
GOSUB OutCodeData
OutBuf="mov dword [edi+"+STR$(BackColorOffs)+"],eax"
GOSUB OutCodeData
OutBuf="invoke InvalidateRect, dword ["+HandleName+"],NULL,TRUE"
GOSUB OutCodeData
RETURN
...
OutBuf="mov edi,[!TargetGUIDesc]"
GOSUB OutCodeData
OutBuf="bts dword [edi+"+STR$(StatusOffs)+"],4"
GOSUB OutCodeData
OutBuf="mov dword [edi+"+STR$(ForeColorOffs)+"],eax"
GOSUB OutCodeData
OutBuf="invoke InvalidateRect, dword ["+HandleName+"],NULL,TRUE"
GOSUB OutCodeData
RETURN
...
pgText:
OutBuf="invoke SendMessage, dword ["+HandleName+"],WM_GETTEXT,_BufSize,[_IOBuffer]"
GOSUB OutCodeData
GUITempName="_IOBuffer"
RETURN
...
pgSciText:
OutBuf="invoke SendMessage, dword ["+HandleName+"],2182,_BufSize,[_IOBuffer]"
GOSUB OutCodeData
GUITempName="_IOBuffer"
RETURN
...
OutBuf="mov edi,[!TargetGUIDesc]"
GOSUB OutCodeData
OutBuf="invoke SendMessage, dword ["+HandleName+"],2004,0,0"
GOSUB OutCodeData
OutBuf="invoke SendMessage, dword ["+HandleName+"],2003,0,["+TSymName+"]"
GOSUB OutCodeData
RETURN
...
GOSUB OutCodeData
OutBuf="invoke ReadFile,[!FileHandle],[!FilBufAdr],[!FilBufSiz],!FilBufSiz,0"
GOSUB OutCodeData
OutBuf="cmp eax,0"
GOSUB OutCodeData
INC OELabelNum
...
OutBuf="mov edi,[!TargetGUIDesc]"
GOSUB OutCodeData
OutBuf="invoke SendMessage, dword [edi+44],2004,0,0"
GOSUB OutCodeData
OutBuf="invoke SendMessage, dword [edi+44],2001,[!FilBufSiz],[!FilBufAdr]"
GOSUB OutCodeData
...
OutBuf="mov edi,[!TargetGUIDesc]"
GOSUB OutCodeData
OutBuf="invoke SendMessage, dword [edi+44],2183,0,0"
GOSUB OutCodeData
OutBuf="mov [!FilBufSiz],eax"
GOSUB OutCodeData
...
OutBuf="mov edi,[!TargetGUIDesc]"
GOSUB OutCodeData
OutBuf="invoke SendMessage, dword [edi+44],2182,[!FilBufSiz],[!FilBufAdr]"
GOSUB OutCodeData
OutBuf="mov edi,[!TargetGUIDesc]"
GOSUB OutCodeData
OutBuf="invoke SendMessage, dword [edi+44],2014,0,0"
GOSUB OutCodeData
...
OutBuf="pop eax"
GOSUB OutCodeData
OutBuf="invoke SendMessage, dword ["+HandleName+"],2001,eax,[_ArgSafe0]"
GOSUB OutCodeData
RETURN
...
OutBuf="pop edi"
GOSUB OutCodeData
OutBuf="invoke SendMessage, dword ["+HandleName+"],LB_GETTEXT,eax,[_IOBuffer]"
GOSUB OutCodeData
GUITempName="_IOBuffer"
RETURN
...
OutBuf="pop edi"
GOSUB OutCodeData
OutBuf="invoke SendMessage, dword ["+HandleName+"],CB_GETLBTEXT,eax,[_IOBuffer]"
GOSUB OutCodeData
GUITempName="_IOBuffer"
RETURN
