...
CONST WidthOffs=24
CONST HeightOffs=28
CONST ForeColorOffs=32
CONST BackColorOffs=36

CONST WinDestroyed=0
CONST WinEnabled=1
CONST WinVisible=2
CONST WinChangeColor=3
...
invoke CreateWindowEx,0,!OBMainClass,!title,WS_VISIBLE+WS_OVERLAPPEDWINDOW,0,0,0,0,NULL,NULL,[!hinstance],NULL
mov [OBMain],eax
...
CONST SLIDER=107
CONST SPINNER=108
CONST PROGRESSBAR=109
CONST CALENDAR=110
CONST HEADER=111
CONST TREEVIEW=112
CONST TABFOLDER=113
CONST BUTTONLISTBOX=114
CONST TOOLBAR=115
CONST STATUSBAR=116
CONST CHECKBOX=117
CONST RADIOBUTTON=118
TABLE ObjTable AS ObjData
 0,STDCTL,"form","HAVIS","0","0",600,400,FormSets,FormGets,FormFcns
 0,STDCTL,"button","BUTTON","0","WS_VISIBLE+WS_CHILD+BS_DEFPUSHBUTTON",80,30,ButtonSets,ButtonGets,ButtonFcns
 0,STDCTL,"statictext","STATIC","0","SS_CENTER+SS_NOTIFY+WS_VISIBLE+WS_CHILD",80,30,StaticTextSets,StaticTextGets,StaticTextFcns
 0,STDCTL,"combobox","COMBOBOX","0","WS_VSCROLL+WS_VISIBLE+WS_CHILD+CBS_DROPDOWN",80,30,ComboBoxSets,ComboBoxGets,ComboBoxFcns
 0,STDCTL,"textbox","EDIT","WS_EX_CLIENTEDGE","WS_VISIBLE+WS_CHILD",80,30,TextBoxSets,TextBoxGets,TextBoxFcns
 0,STDCTL,"frame","BUTTON","0","WS_VISIBLE+WS_CHILD+BS_GROUPBOX",200,200,FrameSets,FrameGets,FrameFcns
 0,STDCTL,"listbox","LISTBOX","0","WS_VSCROLL+WS_VISIBLE+WS_CHILD+LBS_NOTIFY",200,100,ListBoxSets,ListBoxGets,ListBoxFcns
 0,COMCTL,"slider","msctls_trackbar32","0","WS_VISIBLE+WS_CHILD",100,30,SliderSets,SliderGets,SliderFcns
 0,COMCTL,"spinner","msctls_updown32","0","WS_VISIBLE+WS_CHILD",40,30,SpinnerSets,SpinnerGets,SpinnerFcns
 0,COMCTL,"progressbar","msctls_progress32","0","WS_VISIBLE+WS_CHILD",100,30,ProgressBarSets,ProgressBarGets,ProgressBarFcns
 0,COMCTL,"calendar","SysMonthCal32","0","WS_VISIBLE+WS_CHILD",200,150,CalendarSets,CalendarGets,CalendarFcns
 0,COMCTL,"header","SysHeader32","0","WS_VISIBLE+WS_CHILD",80,30,HeaderSets,HeaderGets,HeaderFcns
 0,COMCTL,"treeview","SysTreeView32","0","WS_VISIBLE+WS_CHILD",200,200,TreeViewSets,TreeViewGets,TreeViewFcns
 0,COMCTL,"tabfolder","SysTabControl32","0","WS_VISIBLE+WS_CHILD",200,200,TabFolderSets,TabFolderGets,TabFolderFcns
 0,COMCTL,"buttonlistbox","ButtonListBox","0","WS_VISIBLE+WS_CHILD",200,200,ButtonListBoxSets,ButtonListBoxGets,ButtonListBoxFcns
 0,COMCTL,"toolbar","ToolbarWindow32","0","WS_VISIBLE+WS_CHILD",200,20,ToolBarSets,ToolBarGets,ToolBarFcns
 0,COMCTL,"statusbar","msctls_statusbar32","0","WS_VISIBLE+WS_CHILD",200,200,StatusBarSets,StatusBarGets,StatusBarFcns
 0,STDCTL,"checkbox","BUTTON","0","WS_VISIBLE+WS_CHILD+BS_AUTOCHECKBOX",80,30,CheckBoxSets,CheckBoxGets,CheckBoxFcns
 0,STDCTL,"radiobutton","BUTTON","0","WS_VISIBLE+WS_CHILD+BS_AUTORADIOBUTTON",80,30,RadioButtonSets,RadioButtonGets,RadioButtonFcns
 0,0,"%","","","",0,0,MainLoop,MainLoop,MainLoop
ENDTABLE
...
IF GUIFlag<>0 THEN
	...
	LOOP
		INC ObjNdx
		TempStr=ObjTable(ObjNdx).ObjName
		EXITIF TempStr="%"
		LastObj=ObjNdx
		ObjTable(ObjNdx).ObjCheckWord=CHKWORD(TempStr)
...
GOSUB OutCodeData
OutBuf="invoke SetWindowPos,["+ObjectName+"],HWND_BOTTOM,[_ArgSafe0],[_ArgSafe1],[_ArgSafe2],[_ArgSafe3],0"
GOSUB OutCodeData
GOTO MainLoop
...
GOSUB OutCodeData
TempStr=ObjectNameSafe
ObjectNameSafe="!"+TempStr
...
IF DMArray<>0 OR TDataType=COMPLEX THEN
	...
	ELSE
		...
		GOSUB OutDim
		TempStr=TempStr+SymType+STR$(ArraySize/40)
	ENDIF
ELSE
	IF TDataSize=2 THEN
		OutBuf="align 2"
