...
DIM FirstControlName AS STRING*28
DIM LastControlName AS STRING*28
...
TYPE ObjData
	...
	ObjSource AS LONG
	ObjName AS STRING*16
	ObjTypeName AS STRING*32
	ObjExtStyle AS STRING*32
	ObjStyle AS STRING*100
	ObjDefaultWidth AS LONG
	ObjDefaultHeight AS LONG
	ObjPropSets AS LABEL
	ObjPropGets AS LABEL
	ObjPropFcns AS LABEL
	ObjPropStyles AS LABEL
END Type
...
TEXT ProgressBarSets

ENDTEXT
TEXT ProgressBarGets

ENDTEXT
TEXT ProgressBarFcns

ENDTEXT
TEXT ProgressBarStyles
PBS_SMOOTH
PBS_VERTICAL
ENDTEXT
...
TEXT ButtonListBoxSets

ENDTEXT
TEXT ButtonListBoxGets

ENDTEXT
TEXT ButtonListBoxFcns

ENDTEXT
TEXT ButtonListBoxStyles
...
TEXT RadioButtonSets

ENDTEXT
TEXT RadioButtonGets

ENDTEXT
TEXT RadioButtonFcns

ENDTEXT
TEXT RadioButtonStyles
BS_AUTORADIOBUTTON
BS_BOTTOM
BS_CENTER
BS_FLAT
...
cmp eax,0
jne !UserDataOK
invoke GetParent,[lparam]
invoke GetWindowLong,eax,GWL_USERDATA
cmp eax,0
je !DefWndProc
!UserDataOK:
mov esi,eax
mov eax,[esi+FwdPtrOffs]
mov [!dsFwdPtr],eax
mov eax,[esi+IDOffs]
mov [!dsID],eax
mov eax,[esi+OwnerOffs]
mov [!dsOwner],eax
mov eax,[esi+StatusOffs]
mov [!dsStatus],eax
mov eax,[esi+LeftOffs]
mov [!dsLeft],eax
mov eax,[esi+TopOffs]
mov [!dsTop],eax
mov eax,[esi+WidthOffs]
mov [!dsWidth],eax
mov eax,[esi+HeightOffs]
mov [!dsHeight],eax
...
cmp [!dsType],!CT_TEXTBOX
je !ListOrTextOrCombo
cmp [!dsType],!CT_LISTBOX
je !ListOrTextOrCombo
cmp [!dsType],!CT_COMBOBOX
je !ListOrTextOrCombo
...
TABLE KeyTable AS KeyData
 ...
 0,"additem",AddItemX
 0,"setbackcolor",SetBackColorX
 0,"setforecolor",SetForeColorX
 0,"msgbox",MsgBoxX
 0,"%",MainLoop
ENDTABLE
...
TABLE ObjTable AS ObjData
 0,STDCTL,"form","HAVIS","0","0",600,400,FormSets,FormGets,FormFcns,FormStyles
 0,STDCTL,"button","BUTTON","0","WS_VISIBLE+WS_CHILD+BS_DEFPUSHBUTTON",80,30,ButtonSets,ButtonGets,ButtonFcns,ButtonStyles
 0,STDCTL,"statictext","STATIC","0","SS_CENTER+SS_NOTIFY+WS_VISIBLE+WS_CHILD",80,30,StaticTextSets,StaticTextGets,StaticTextFcns,StaticTextStyles
 0,STDCTL,"combobox","COMBOBOX","0","WS_VSCROLL+WS_VISIBLE+WS_CHILD+CBS_DROPDOWN",80,30,ComboBoxSets,ComboBoxGets,ComboBoxFcns,ComboBoxStyles
 0,STDCTL,"textbox","EDIT","WS_EX_CLIENTEDGE","WS_VISIBLE+WS_CHILD",80,30,TextBoxSets,TextBoxGets,TextBoxFcns,TextBoxStyles
 0,STDCTL,"frame","BUTTON","0","WS_VISIBLE+WS_CHILD+BS_GROUPBOX",200,200,FrameSets,FrameGets,FrameFcns,FrameStyles
 0,STDCTL,"listbox","LISTBOX","0","WS_VSCROLL+WS_VISIBLE+WS_CHILD+LBS_NOTIFY",200,100,ListBoxSets,ListBoxGets,ListBoxFcns,ListBoxStyles
 0,COMCTL,"slider","msctls_trackbar32","0","WS_VISIBLE+WS_CHILD+256",100,30,SliderSets,SliderGets,SliderFcns,SliderStyles
 0,COMCTL,"spinner","msctls_updown32","0","WS_VISIBLE+WS_CHILD",40,30,SpinnerSets,SpinnerGets,SpinnerFcns,SpinnerStyles
 0,COMCTL,"progressbar","msctls_progress32","0","WS_VISIBLE+WS_CHILD",100,30,ProgressBarSets,ProgressBarGets,ProgressBarFcns,ProgressBarStyles
 0,COMCTL,"calendar","SysMonthCal32","0","WS_VISIBLE+WS_CHILD",200,150,CalendarSets,CalendarGets,CalendarFcns,CalendarStyles
 0,COMCTL,"header","SysHeader32","0","WS_VISIBLE+WS_CHILD",80,30,HeaderSets,HeaderGets,HeaderFcns,HeaderStyles
 0,COMCTL,"treeview","SysTreeView32","0","WS_VISIBLE+WS_CHILD",200,200,TreeViewSets,TreeViewGets,TreeViewFcns,TreeViewStyles
 0,COMCTL,"tabfolder","SysTabControl32","0","WS_VISIBLE+WS_CHILD",200,200,TabFolderSets,TabFolderGets,TabFolderFcns,TabFolderStyles
 0,COMCTL,"buttonlistbox","ButtonListBox","0","WS_VISIBLE+WS_CHILD",200,200,ButtonListBoxSets,ButtonListBoxGets,ButtonListBoxFcns,ButtonListBoxStyles
 0,COMCTL,"toolbar","ToolbarWindow32","0","WS_VISIBLE+WS_CHILD",200,20,ToolBarSets,ToolBarGets,ToolBarFcns,ToolBarStyles
 0,COMCTL,"statusbar","msctls_statusbar32","0","WS_VISIBLE+WS_CHILD",200,200,StatusBarSets,StatusBarGets,StatusBarFcns,StatusBarStyles
 0,STDCTL,"checkbox","BUTTON","0","WS_VISIBLE+WS_CHILD+BS_AUTOCHECKBOX",80,30,CheckBoxSets,CheckBoxGets,CheckBoxFcns,CheckBoxStyles
 0,STDCTL,"radiobutton","BUTTON","0","WS_VISIBLE+WS_CHILD+BS_AUTORADIOBUTTON",80,30,RadioButtonSets,RadioButtonGets,RadioButtonFcns,RadioButtonStyles
ENDTABLE
...
OutBuf=""
GOSUB OutDeclare
OutBuf="_BufSize equ "+STR$(_BufSize)
GOSUB OutDeclare
...
IF GUIFlag<>0 THEN
	...
	OutBuf="!dsType rd 1"
	GOSUB OutDim
	OutBuf="!dsHandle rd 1"
	GOSUB OutDim
	LastControlName="OBMain"
	RESTORE PreCodeSeg2
	GOSUB OutPreCode
	RESTORE GUIEquates
	GOSUB OutEquates
...
EndTypeX:
TempStr="Fatal Error: EndType while not in Type"
GOSUB OutPrint
END
GOTO MainLoop
...
GOSUB GetIntOp
ErrMain
TempStyle="!"+ObjectName
OutBuf="mov ["+TempStyle+"+"+STR$(LeftOffs)+"],eax"
GOSUB OutCodeData
CommaMain
GOSUB GetIntOp
ErrMain
OutBuf="mov ["+TempStyle+"+"+STR$(TopOffs)+"],eax"
GOSUB OutCodeData
CommaMain
GOSUB GetIntOp
ErrMain
OutBuf="mov ["+TempStyle+"+"+STR$(WidthOffs)+"],eax"
GOSUB OutCodeData
CommaMain
GOSUB GetIntOp
ErrMain
OutBuf="mov ["+TempStyle+"+"+STR$(HeightOffs)+"],eax"
GOSUB OutCodeData
OutBuf="invoke SetWindowPos,["+ObjectName+"],HWND_BOTTOM,["+TempStyle+"+"+STR$(LeftOffs)+"],["
OutBuf=OutBuf+TempStyle+"+"+STR$(TopOffs)+"],["+TempStyle+"+"+STR$(WidthOffs)+"],["+TempStyle+"+"+STR$(HeightOffs)+"],0"
GOSUB OutCodeData
GOTO MainLoop
...
OutBuf="invoke CreateWindowEx,"+ObjTable(ObjectTypeSafe).ObjExtStyle+","+TempStr+",NULL,"+TempStyle+",0,0,"+DefaultWidth+","+DefaultHeight+",["+ObjectParent+"],"+STR$(ObjectID)+",[!hinstance],NULL"
GOSUB OutCodeData
OutBuf="mov dword ["+ObjectNameSafe+"],eax"
GOSUB OutCodeData
OutBuf="invoke SetWindowLong,["+ObjectNameSafe+"],GWL_USERDATA,!"+ObjectNameSafe
GOSUB OutCodeData
OutBuf="mov dword [!"+ObjectNameSafe+"+"+STR$(HandleOffs)+"],eax"
GOSUB OutCodeData
OutBuf="mov dword [!"+LastControlName+"+"+STR$(FwdPtrOffs)+"],!"+ObjectNameSafe
GOSUB OutCodeData
LastControlName=ObjectNameSafe	
ObjectName=ObjectNameSafe
ObjectNameSafe="!"+ObjectName
OutBuf="mov dword ["+ObjectNameSafe+"+"+STR$(FwdPtrOffs)+"],0"
GOSUB OutCodeData
OutBuf="mov dword ["+ObjectNameSafe+"+"+STR$(TypeOffs)+"],"+STR$(ObjectTypeSafe+99)
GOSUB OutCodeData
OutBuf="mov dword ["+ObjectNameSafe+"+"+STR$(IDOffs)+"],"+STR$(ObjectID)
GOSUB OutCodeData
OutBuf="mov eax,["+ObjectParent+"]"
GOSUB OutCodeData
OutBuf="mov dword ["+ObjectNameSafe+"+"+STR$(OwnerOffs)+"],eax"
GOSUB OutCodeData
OutBuf="mov dword ["+ObjectNameSafe+"+"+STR$(StatusOffs)+"],6"
GOSUB OutCodeData
OutBuf="mov dword ["+ObjectNameSafe+"+"+STR$(TopOffs)+"],0"
GOSUB OutCodeData
OutBuf="mov dword ["+ObjectNameSafe+"+"+STR$(LeftOffs)+"],0"
GOSUB OutCodeData
OutBuf="mov dword ["+ObjectNameSafe+"+"+STR$(WidthOffs)+"],"+DefaultWidth
GOSUB OutCodeData
OutBuf="mov dword ["+ObjectNameSafe+"+"+STR$(HeightOffs)+"],"+DefaultHeight
GOSUB OutCodeData
OutBuf="mov dword ["+ObjectNameSafe+"+"+STR$(BackColorOffs)+"],0"
GOSUB OutCodeData
OutBuf="mov dword ["+ObjectNameSafe+"+"+STR$(ForeColorOffs)+"],0"
GOSUB OutCodeData
GOTO MainLoop
...
IF DumpSyms=$ff THEN
	...
	TempStr=""
	GOSUB OutPrint
	TempStr=STR$(Ctr1-UserSym)+" symbols"
	GOSUB OutPrint
	TempStr=""
	GOSUB OutPrint
ENDIF
...
IF DMArray<>0 OR TDataType=COMPLEX THEN
	...
	ELSE
		...
		GOSUB OutDim
		TempStr=TempStr+SymType+STR$(ArraySize/48)
	ENDIF
ELSE
	IF TDataSize=2 THEN
		OutBuf="align 2"
