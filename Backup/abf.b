...
TABLE TailStrTable AS STRING*18
"__TailStr:"
"push ebx"
"mov edi,[esi]"
"mov ecx,[esi+4]"
...
TABLE SetStrConstTable AS STRING*22
"__SetStrConst:"
"mov al,[esi]"
"mov [edi],al"
"or al,al"
...
TABLE InpDataTable AS STRING*64
"__InpData:"
...
TABLE MidStrTable AS STRING*16
"__MidStr:"
"dec eax"
"mov edi,[esi]"
"add edi,eax"
...
TABLE MovArgTable AS STRING*20
"__MovArg:"
"mov esi,[_ArgList]"
"mov edx,[edi+4]"
"mov edi,[edi]"
...
TABLE CmpStrTable AS STRING*20
"__CmpStr:"
"mov edx,[edi+4]"
"mov edi,[edi]"
"mov ecx,[esi+4]"
...
TABLE MovStrTable AS STRING*18
"__MovStr:"
"push ebx"
"mov edx,[edi+4]"
"mov edi,[edi]"
...
TABLE StrLenTable AS STRING*20
"__StrLen:"
"xor eax,eax"
"__StrLenGetVec:"
"mov edi,[esi]"
...
TABLE RightStrTable AS STRING*18
"__RightStr:"
"mov edi,[esi]"
"mov ecx,[esi+4]"
"__RightStrLen:"
...
EndTextX:
Print "Fatal Error: EndText while not in Text"
END
GOTO MainLoop

EndTypeX:
Print "Fatal Error: EndType while not in Type"
END
GOTO MainLoop
...
FOR I=1 TO TABLESIZE(MovArgTable)
	OutBuf=MovArgTable(I)
	GOSUB OutFunction
NEXT I

IF UseInpData=TRUE THEN
	FOR I=1 TO TABLESIZE(InpDataTable)
		OutBuf=InpDataTable(I)
		GOSUB OutFunction
	NEXT I
ENDIF

IF UseData=TRUE THEN
	FOR I=1 TO TABLESIZE(DataTable)
		OutBuf=DataTable(I)
		GOSUB OutFunction
	NEXT I
ENDIF
...
IF UseCmpStr=TRUE THEN
	FOR I=1 TO TABLESIZE(CmpStrTable)
		OutBuf=CmpStrTable(I)
		GOSUB OutFunction
	NEXT I
ENDIF

IF UseMovStr=TRUE THEN
	FOR I=1 TO TABLESIZE(MovStrTable)
		OutBuf=MovStrTable(I)
		GOSUB OutFunction
	NEXT I
ENDIF

IF UseStrLen=TRUE THEN
	FOR I=1 TO TABLESIZE(StrLenTable)
		OutBuf=StrLenTable(I)
		GOSUB OutFunction
	NEXT I
ENDIF

IF UseAtoL=TRUE THEN
	FOR I=1 TO TABLESIZE(AtoLTable)
		OutBuf=AtoLTable(I)
		GOSUB OutFunction
	NEXT I
ENDIF
...
IF UseBtoA=TRUE THEN
	FOR I=1 TO TABLESIZE(BtoATable)
		OutBuf=BtoATable(I)
		GOSUB OutFunction
	NEXT I
ENDIF
...
IF UseSetStrConst=TRUE THEN
	FOR I=1 TO TABLESIZE(SetStrConstTable)
		OutBuf=SetStrConstTable(I)
		GOSUB OutFunction
	NEXT I
ENDIF

IF UseMidStr=TRUE THEN
	FOR I=1 TO TABLESIZE(MidStrTable)
		OutBuf=MidStrTable(I)
		GOSUB OutFunction
	NEXT I
ENDIF

IF UseRightStr=TRUE THEN
	FOR I=1 TO TABLESIZE(RightStrTable)
		OutBuf=RightStrTable(I)
		GOSUB OutFunction
	NEXT I
ENDIF

IF UseTailStr=TRUE THEN
	FOR I=1 TO TABLESIZE(TailStrTable)
		OutBuf=TailStrTable(I)
		GOSUB OutFunction
	NEXT I
ENDIF

IF UseLCase=TRUE THEN
	FOR I=1 TO TABLESIZE(LCaseTable)
		OutBuf=LCaseTable(I)
		GOSUB OutFunction
	NEXT I
ENDIF
...
IF UseUCase=TRUE THEN
	FOR I=1 TO TABLESIZE(UCaseTable)
		OutBuf=UCaseTable(I)
		GOSUB OutFunction
	NEXT I
ENDIF
