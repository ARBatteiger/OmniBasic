...
invoke LoadLibrary,!!DrawProgress
...
OBMain_CREATE:
; LN:6 construct frame,10,10,100,100
mov edi,!frame
mov [!TargetGUIDesc],edi
mov eax,10
...
invoke CreateWindowEx,0,!ControlType6,NULL,$50000007, dword [edi+LeftOffs], dword [edi+TopOffs], dword [edi+WidthOffs], dword [edi+HeightOffs], dword [!OBMain],101,[!hinstance],!frame
...
_Lbl1:
; LN:7 construct rb1,20,20,50,20 in frame
mov edi,!rb1
mov [!TargetGUIDesc],edi
mov eax,20
mov dword [edi+LeftOffs],eax
...
jc _Lbl2
call __SetRightBottom
invoke CreateWindowEx,0,!ControlType19,NULL,$50000009, dword [edi+LeftOffs], dword [edi+TopOffs], dword [edi+WidthOffs], dword [edi+HeightOffs], dword [!frame+HandleOffs],102,[!hinstance],!frame
mov dword edi,[!TargetGUIDesc]
mov dword [edi+HandleOffs],eax
invoke SetWindowLong, dword eax,GWL_USERDATA,edi
bts dword [!frame+StatusOffs],WinSubClassed
jc _SCLbl1
invoke SetWindowLong, dword [!frame+HandleOffs],GWL_WNDPROC,!SubClassProc1
mov [!OldProc1],eax
_SCLbl1:
mov edi,[!TargetGUIDesc]
mov dword [edi+TypeOffs],118
mov dword [edi+IDOffs],102
mov eax,[!frame+HandleOffs]
mov dword [edi+OwnerOffs],eax
mov dword [edi+ArrayOffs],0
mov dword [edi+StatusOffs],$07
mov dword [edi+BackColorOffs],$ffffffff
