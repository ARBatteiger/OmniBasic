...
_StrConst1 db "Havis",0
_StrConst2 db "doofus",0
!ObjectCount dd 3
...
; LN:4 DIM OBLogFont AS LOGFONT
align 4
OBLogFont rb 60
align 4
; LN:4 DIM OBFont AS FONT
OBFont rd 1
...
invoke CreateWindowEx,0,!ControlType2,[_NullStr],$50000001, dword [edi+LeftOffs], dword [edi+TopOffs], dword [edi+WidthOffs], dword [edi+HeightOffs], dword [!OBMain],101,[hInstance],0
...
mov [_ArgSafe3],0
call __SetRightBottom
invoke CreateWindowEx,0,!ControlType2,[_NullStr],$50000001, dword [edi+LeftOffs], dword [edi+TopOffs], dword [edi+WidthOffs], dword [edi+HeightOffs], dword [!OBMain],102,[hInstance],0
mov dword [edi+HandleOffs],eax
invoke SetWindowLong, dword eax,GWL_USERDATA,edi
mov dword [edi+TTcbSizeOffs],44
mov eax,[_ArgSafe3]
