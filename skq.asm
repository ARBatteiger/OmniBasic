...
_StrConst16 db "CheckBox",0
_StrConst17 db "Frame",0
_StrConst18 db "Red",0
_StrConst19 db "Green",0
_StrConst20 db "Blue",0
_StrConst21 db "Black",0
_StrConst22 db "White",0
_StrConst23 db "TabFolder",0
_StrConst24 db "Item1",0
_StrConst25 db "Item2",0
_StrConst26 db "Item3",0
_StrConst27 db "Item4",0
_StrConst28 db "Item5",0
_StrConst29 db "Item6",0
_StrConst30 db "Item7",0
_StrConst31 db "Item8",0
...
!CheckBox rd 12
CheckBox rd 1
; LN:21 DIM RadioButton1 AS RADIOBUTTON
align 4
!RadioButton1 rd 12
RadioButton1 rd 1
; LN:22 DIM RadioButton2 AS RADIOBUTTON
align 4
!RadioButton2 rd 12
RadioButton2 rd 1
; LN:23 DIM RadioButton3 AS RADIOBUTTON
align 4
!RadioButton3 rd 12
RadioButton3 rd 1
; LN:24 DIM RadioButton4 AS RADIOBUTTON
align 4
!RadioButton4 rd 12
RadioButton4 rd 1
; LN:25 DIM RadioButton5 AS RADIOBUTTON
align 4
!RadioButton5 rd 12
RadioButton5 rd 1
; LN:26 dim test1(10) as button
align 4
align 4
!test1 rd 120
test1 rd 10
; LN:28 type junk
; LN:33 dim trash(10) as junk
align 4
trash rb 120
...
mov dword [!OBMain+32],$0000ff
mov dword [!OBMain+36],$00ffff
...
OBMain_Load:
; LN:36 SETPOSITION OBMain,200,200,624,368
mov eax,200
mov [!OBMain+16],eax
mov eax,200
mov [!OBMain+20],eax
...
; LN:37 SETTEXT OBMain,"Innomation Systems, Inc."
mov esi,_StrConst1
mov [_TmpVec1],esi
mov [_TmpVec1+4],25
mov [_TmpVec1+8],0
...
mov esi,_StrConst2
call __SetStrConst
; LN:41 'setbackcolor OBMain,$ff0000
; LN:43 CONSTRUCT ToolBar
...
; LN:48 SETPOSITION ExitButton,550,280,64,32
mov eax,550
...
; LN:49 SETTEXT ExitButton,"E&xit"
mov esi,_StrConst3
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[ExitButton],WM_SETTEXT,0,[_TmpVec1]
; LN:51 CONSTRUCT TextBox
...
; LN:52 SETPOSITION TextBox,100,40,80,20
mov eax,100
mov [!TextBox+16],eax
mov eax,40
mov [!TextBox+20],eax
...
; LN:53 SETTEXT TextBox,"TextBox"
mov esi,_StrConst4
mov [_TmpVec1],esi
mov [_TmpVec1+4],8
mov [_TmpVec1+8],0
invoke SendMessage,[TextBox],WM_SETTEXT,0,[_TmpVec1]
; LN:54 SETCOLOR TextBox,$c0c000,$0080ff
...
; LN:57 SETPOSITION ComboBox,10,40,80,100
mov eax,10
mov [!ComboBox+16],eax
mov eax,40
mov [!ComboBox+20],eax
...
; LN:58 SETTEXT ComboBox,a$
invoke SendMessage,[ComboBox],WM_SETTEXT,0,[a$]
; LN:59 SETCOLOR ComboBox,$000080,$00ffff
...
; LN:60 ADDITEM ComboBox,"Item1"
mov esi,_StrConst5
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[ComboBox],CB_ADDSTRING,0,[_TmpVec1]
; LN:61 ADDITEM ComboBox,"Item2"
mov esi,_StrConst6
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[ComboBox],CB_ADDSTRING,0,[_TmpVec1]
; LN:62 ADDITEM ComboBox,"Item3"
mov esi,_StrConst7
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[ComboBox],CB_ADDSTRING,0,[_TmpVec1]
; LN:63 ADDITEM ComboBox,"Item4"
mov esi,_StrConst8
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[ComboBox],CB_ADDSTRING,0,[_TmpVec1]
; LN:64 ADDITEM ComboBox,"Item5"
mov esi,_StrConst9
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[ComboBox],CB_ADDSTRING,0,[_TmpVec1]
; LN:65 ADDITEM ComboBox,"Item6"
mov esi,_StrConst10
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[ComboBox],CB_ADDSTRING,0,[_TmpVec1]
; LN:67 CONSTRUCT Header
...
; LN:68 SETPOSITION Header,10,80,80,20
mov eax,10
mov [!Header+16],eax
mov eax,80
mov [!Header+20],eax
...
; LN:69 SETTEXT Header,"Header"
mov esi,_StrConst11
mov [_TmpVec1],esi
mov [_TmpVec1+4],7
mov [_TmpVec1+8],0
invoke SendMessage,[Header],WM_SETTEXT,0,[_TmpVec1]
; LN:71 CONSTRUCT StaticText1
...
; LN:72 SETPOSITION StaticText1,200,40,80,15
mov eax,200
...
; LN:73 SETTEXT StaticText1,"StaticText1"
mov esi,_StrConst12
mov [_TmpVec1],esi
mov [_TmpVec1+4],12
mov [_TmpVec1+8],0
invoke SendMessage,[StaticText1],WM_SETTEXT,0,[_TmpVec1]
; LN:74 SETCOLOR StaticText1,$ff,$ffffff
...
; LN:77 SETPOSITION StaticText2,200,55,80,15
mov eax,200
...
; LN:78 SETTEXT StaticText2,"StaticText2"
mov esi,_StrConst13
mov [_TmpVec1],esi
mov [_TmpVec1+4],12
mov [_TmpVec1+8],0
invoke SendMessage,[StaticText2],WM_SETTEXT,0,[_TmpVec1]
; LN:79 SETCOLOR StaticText2,$ff00,$ff0000
...
; LN:82 SETPOSITION StaticText3,200,70,80,15
mov eax,200
...
; LN:83 SETTEXT StaticText3,"StaticText2"
mov esi,_StrConst14
mov [_TmpVec1],esi
mov [_TmpVec1+4],12
mov [_TmpVec1+8],0
invoke SendMessage,[StaticText3],WM_SETTEXT,0,[_TmpVec1]
; LN:84 SETCOLOR StaticText3,$ff0000,$00ffff
...
; LN:86 CONSTRUCT Slider
invoke CreateWindowEx,0,!ControlType8,NULL,WS_VISIBLE+WS_CHILD,0,0,100,30,[OBMain],110,[!hinstance],NULL
...
; LN:90 '+invoke UpdateWindow,[Slider]
; LN:91 SETPOSITION Slider,300,40,120,20
mov eax,300
mov [!Slider+16],eax
mov eax,40
mov [!Slider+20],eax
...
; LN:92 SETTEXT Slider,"Frame",$80ff
mov esi,_StrConst15
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[Slider],WM_SETTEXT,0,[_TmpVec1]
; LN:93 SETCOLOR Slider,$80ff,0
...
; LN:95 CONSTRUCT CheckBox
invoke CreateWindowEx,0,!ControlType18,NULL,WS_VISIBLE+WS_CHILD+BS_AUTOCHECKBOX,0,0,80,30,[OBMain],111,[!hinstance],NULL
mov dword [CheckBox],eax
mov dword [!CheckBox+44],eax
mov dword [!Slider+0],!CheckBox
mov dword [!CheckBox+0],0
mov dword [!CheckBox+40],117
mov dword [!CheckBox+4],111
mov eax,[OBMain]
...
; LN:96 SETPOSITION CheckBox,440,40,100,20
mov eax,440
mov [!CheckBox+16],eax
mov eax,40
mov [!CheckBox+20],eax
...
; LN:97 SETTEXT CheckBox,"CheckBox"
mov esi,_StrConst16
mov [_TmpVec1],esi
mov [_TmpVec1+4],9
mov [_TmpVec1+8],0
invoke SendMessage,[CheckBox],WM_SETTEXT,0,[_TmpVec1]
; LN:98 SETCOLOR CheckBox,$ff0000,$00ffff
...
; LN:102 CONSTRUCT Frame
invoke CreateWindowEx,0,!ControlType6,NULL,WS_VISIBLE+WS_CHILD+BS_GROUPBOX,0,0,200,200,[OBMain],112,[!hinstance],NULL
mov dword [Frame],eax
mov dword [!Frame+44],eax
mov dword [!CheckBox+0],!Frame
mov dword [!Frame+0],0
mov dword [!Frame+40],105
mov dword [!Frame+4],112
mov eax,[OBMain]
...
; LN:103 SETPOSITION Frame,10,70,130,140
mov eax,10
mov [!Frame+16],eax
mov eax,70
mov [!Frame+20],eax
...
; LN:104 SETTEXT Frame,"Frame"
mov esi,_StrConst17
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[Frame],WM_SETTEXT,0,[_TmpVec1]
; LN:106 SETCOLOR Frame,$00ffff,$0000ff
...
; LN:108 CONSTRUCT RadioButton1 IN Frame
invoke CreateWindowEx,0,!ControlType19,NULL,WS_VISIBLE+WS_CHILD+BS_AUTORADIOBUTTON,0,0,80,30,[Frame],113,[!hinstance],NULL
...
; LN:109 SETPOSITION RadioButton1,5,30,100,20
mov eax,5
...
; LN:110 SETTEXT RadioButton1,"Red"
mov esi,_StrConst18
mov [_TmpVec1],esi
mov [_TmpVec1+4],4
mov [_TmpVec1+8],0
invoke SendMessage,[RadioButton1],WM_SETTEXT,0,[_TmpVec1]
; LN:112 CONSTRUCT RadioButton2 IN Frame
...
; LN:113 SETPOSITION RadioButton2,5,50,100,20
mov eax,5
...
; LN:114 SETTEXT RadioButton2,"Green"
mov esi,_StrConst19
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[RadioButton2],WM_SETTEXT,0,[_TmpVec1]
; LN:116 CONSTRUCT RadioButton3 IN Frame
...
; LN:117 SETPOSITION RadioButton3,5,70,100,20
mov eax,5
...
; LN:118 SETTEXT RadioButton3,"Blue"
mov esi,_StrConst20
mov [_TmpVec1],esi
mov [_TmpVec1+4],5
mov [_TmpVec1+8],0
invoke SendMessage,[RadioButton3],WM_SETTEXT,0,[_TmpVec1]
; LN:120 CONSTRUCT RadioButton4 IN Frame
...
; LN:121 SETPOSITION RadioButton4,5,90,100,20
mov eax,5
...
; LN:122 SETTEXT RadioButton4,"Black"
mov esi,_StrConst21
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[RadioButton4],WM_SETTEXT,0,[_TmpVec1]
; LN:124 CONSTRUCT RadioButton5 IN Frame
...
; LN:125 SETPOSITION RadioButton5,5,110,100,20
mov eax,5
...
; LN:126 SETTEXT RadioButton5,"White"
mov esi,_StrConst22
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
...
; LN:132 CONSTRUCT TabFolder
invoke CreateWindowEx,0,!ControlType14,NULL,WS_VISIBLE+WS_CHILD,0,0,200,200,[OBMain],118,[!hinstance],NULL
...
; LN:133 SETPOSITION TabFolder,10,220,100,100
mov eax,10
...
; LN:134 SETTEXT TabFolder,"TabFolder"
mov esi,_StrConst23
mov [_TmpVec1],esi
mov [_TmpVec1+4],10
mov [_TmpVec1+8],0
invoke SendMessage,[TabFolder],WM_SETTEXT,0,[_TmpVec1]
; LN:136 CONSTRUCT ListBox
invoke CreateWindowEx,0,!ControlType7,NULL,WS_VSCROLL+WS_VISIBLE+WS_CHILD+LBS_NOTIFY,0,0,200,100,[OBMain],119,[!hinstance],NULL
mov dword [ListBox],eax
mov dword [!ListBox+44],eax
mov dword [!TabFolder+0],!ListBox
mov dword [!ListBox+0],0
mov dword [!ListBox+40],106
mov dword [!ListBox+4],119
mov eax,[OBMain]
...
; LN:137 SETPOSITION ListBox,150,100,100,100
mov eax,150
mov [!ListBox+16],eax
mov eax,100
mov [!ListBox+20],eax
...
; LN:138 ADDITEM ListBox,"Item1"
mov esi,_StrConst24
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[ListBox],LB_ADDSTRING,0,[_TmpVec1]
; LN:139 ADDITEM ListBox,"Item2"
mov esi,_StrConst25
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[ListBox],LB_ADDSTRING,0,[_TmpVec1]
; LN:140 ADDITEM ListBox,"Item3"
mov esi,_StrConst26
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[ListBox],LB_ADDSTRING,0,[_TmpVec1]
; LN:141 ADDITEM ListBox,"Item4"
mov esi,_StrConst27
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[ListBox],LB_ADDSTRING,0,[_TmpVec1]
; LN:142 ADDITEM ListBox,"Item5"
mov esi,_StrConst28
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[ListBox],LB_ADDSTRING,0,[_TmpVec1]
; LN:143 ADDITEM ListBox,"Item6"
mov esi,_StrConst29
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[ListBox],LB_ADDSTRING,0,[_TmpVec1]
; LN:144 ADDITEM ListBox,"Item7"
mov esi,_StrConst30
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[ListBox],LB_ADDSTRING,0,[_TmpVec1]
; LN:145 ADDITEM ListBox,"Item8"
mov esi,_StrConst31
mov [_TmpVec1],esi
mov [_TmpVec1+4],6
mov [_TmpVec1+8],0
invoke SendMessage,[ListBox],LB_ADDSTRING,0,[_TmpVec1]
; LN:146 SETCOLOR ListBox,$ff0000,$ffffff
...
; LN:148 CONSTRUCT ButtonListBox
invoke CreateWindowEx,0,!ControlType15,NULL,WS_VISIBLE+WS_CHILD,0,0,200,200,[OBMain],120,[!hinstance],NULL
...
; LN:149 SETPOSITION ButtonListBox,150,220,100,100
mov eax,150
...
; LN:151 CONSTRUCT Spinner
invoke CreateWindowEx,0,!ControlType9,NULL,WS_VISIBLE+WS_CHILD,0,0,40,30,[OBMain],121,[!hinstance],NULL
...
; LN:152 SETPOSITION Spinner,270,100,100,20
mov eax,270
mov [!Spinner+16],eax
mov eax,100
mov [!Spinner+20],eax
...
; LN:154 CONSTRUCT ProgressBar
invoke CreateWindowEx,0,!ControlType10,NULL,WS_VISIBLE+WS_CHILD,0,0,100,30,[OBMain],122,[!hinstance],NULL
...
; LN:155 SETPOSITION ProgressBar,390,100,100,20
mov eax,390
...
; LN:157 CONSTRUCT TreeView
invoke CreateWindowEx,0,!ControlType13,NULL,WS_VISIBLE+WS_CHILD,0,0,200,200,[OBMain],123,[!hinstance],NULL
...
; LN:158 SETPOSITION TreeView,510,100,100,100
mov eax,510
mov [!TreeView+16],eax
mov eax,100
mov [!TreeView+20],eax
...
; LN:160 CONSTRUCT Calendar
invoke CreateWindowEx,0,!ControlType11,NULL,WS_VISIBLE+WS_CHILD,0,0,200,150,[OBMain],124,[!hinstance],NULL
...
; LN:161 SETPOSITION Calendar,270,140,200,150
mov eax,270
mov [!Calendar+16],eax
mov eax,140
mov [!Calendar+20],eax
...
; LN:163 'ADDITEM ComboBox,"Item1"
; LN:164 'ADDITEM ComboBox,"Item2"
; LN:165 'ADDITEM ComboBox,"Item3"
; LN:166 'ADDITEM ComboBox,"Item4"
; LN:167 'ADDITEM ComboBox,"Item5"
; LN:168 'ADDITEM ComboBox,"Item6"
; LN:170 RETURN
ret
OBMain_Command:
; LN:173 SETCOLOR StaticText1,$008000,$00ffff
bts dword [!StaticText1+12],3
mov eax,32768
mov [!StaticText1+32],eax
mov eax,65535
