...
; LN:14 begin import dll3.dll
; LN:20 begin import kernel32.dll
!Timers equ 1
...
_StrConst6 db "Button4",0
_StrConst7 db "Button5",0
_StrConst8 db "True",0
_StrConst9 db "False",0
!ObjectCount dd 10
...
;Temporary Vector
_TmpVec1 rd 3
; LN:25 DIM OBLogFont AS LOGFONT
align 4
OBLogFont rb 60
align 4
; LN:25 DIM OBFont AS FONT
OBFont rd 1
...
!OBMain rd 192
; LN:25 DIM Button1 AS BUTTON
!Button1 rd 192
; LN:25 DIM Button2 AS BUTTON
!Button2 rd 192
; LN:25 DIM Button3 AS BUTTON
!Button3 rd 192
; LN:25 DIM Check1 AS CHECKBOX
!Check1 rd 192
; LN:25 DIM TextBox1 AS TEXTBOX
!TextBox1 rd 192
; LN:25 DIM TextBox2 AS TEXTBOX
!TextBox2 rd 192
; LN:25 DIM TextBox3 AS TEXTBOX
!TextBox3 rd 192
; LN:25 DIM Button4 AS BUTTON
!Button4 rd 192
; LN:25 DIM Button5 AS BUTTON
!Button5 rd 192
...
mov [!Button3+104+4],0
mov [!Button4+104],Button4_CLICK
mov [!Button4+104+4],0
mov [!Button5+104],Button5_CLICK
mov [!Button5+104+4],0
ret
; End of Init Section
...
; LN:11 declare fcn tooter(integer,integer) as integer external
; LN:12 declare proc toot(integer,integer) external
; LN:25 OBMain.CREATE
mov edi,!OBMain
mov [!TargetGUIDesc],edi
OBMain_CREATE:
; LN:25 SETPOSITION OBMain,340,150,640,480
mov edi,!OBMain
mov [!TargetGUIDesc],edi
mov eax,340
...
; LN:25 CREATE Button1,10,50,90,30
mov edi,!Button1
mov [!TargetGUIDesc],edi
mov eax,10
mov dword [edi+LeftOffs],eax
...
mov edi,[!TargetGUIDesc]
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_IOBuffer]
; LN:25 CREATE Button2,120,50,90,30
mov edi,!Button2
mov [!TargetGUIDesc],edi
mov eax,120
mov dword [edi+LeftOffs],eax
...
mov edi,[!TargetGUIDesc]
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_IOBuffer]
; LN:25 CREATE Button3,230,50,90,30
mov edi,!Button3
mov [!TargetGUIDesc],edi
mov eax,230
mov dword [edi+LeftOffs],eax
...
mov edi,[!TargetGUIDesc]
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_IOBuffer]
; LN:25 CREATE Check1,230,20,90,20
mov edi,!Check1
mov [!TargetGUIDesc],edi
mov eax,230
mov dword [edi+LeftOffs],eax
...
invoke InvalidateRect, dword [edi+HandleOffs],NULL,TRUE
; LN:25 CREATE TextBox1,10,20,40,20
mov edi,!TextBox1
mov [!TargetGUIDesc],edi
mov eax,10
mov dword [edi+LeftOffs],eax
...
mov edi,[!TargetGUIDesc]
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_IOBuffer]
; LN:25 TextBox1.BACKCOLOR=$ffffff
mov edi,!TextBox1
mov [!TargetGUIDesc],edi
mov eax,16777215
bts dword [edi+StatusOffs],WinChangeBackColor
...
mov dword [edi+ForeColorOffs],eax
invoke InvalidateRect, dword [edi+HandleOffs],NULL,TRUE
; LN:25 CREATE TextBox2,60,20,40,20
mov edi,!TextBox2
mov [!TargetGUIDesc],edi
mov eax,60
mov dword [edi+LeftOffs],eax
...
mov edi,[!TargetGUIDesc]
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_IOBuffer]
; LN:25 TextBox2.BACKCOLOR=$ffffff
mov edi,!TextBox2
mov [!TargetGUIDesc],edi
mov eax,16777215
bts dword [edi+StatusOffs],WinChangeBackColor
...
mov dword [edi+ForeColorOffs],eax
invoke InvalidateRect, dword [edi+HandleOffs],NULL,TRUE
; LN:25 CREATE TextBox3,120,20,90,20
mov edi,!TextBox3
mov [!TargetGUIDesc],edi
mov eax,120
mov dword [edi+LeftOffs],eax
...
mov edi,[!TargetGUIDesc]
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_IOBuffer]
; LN:25 TextBox3.BACKCOLOR=$ffffff
mov edi,!TextBox3
mov [!TargetGUIDesc],edi
mov eax,16777215
bts dword [edi+StatusOffs],WinChangeBackColor
...
mov dword [edi+ForeColorOffs],eax
invoke InvalidateRect, dword [edi+HandleOffs],NULL,TRUE
; LN:25 CREATE Button4,340,50,90,30
mov edi,!Button4
mov [!TargetGUIDesc],edi
mov eax,340
mov dword [edi+LeftOffs],eax
...
mov edi,[!TargetGUIDesc]
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_IOBuffer]
; LN:25 CREATE Button5,450,50,90,30
mov edi,!Button5
mov [!TargetGUIDesc],edi
mov eax,450
mov dword [edi+LeftOffs],eax
...
; LN:27 END EVENT
ret
; LN:29 Button1.command
mov edi,!Button1
mov [!TargetGUIDesc],edi
Button1_command:
; LN:30 ts=TextBox1.text
mov edi,!TextBox1
...
call __AtoL
mov dword [y],eax
; LN:34 Button1.text=str(uf1(x,y))
mov edi,!Button1
mov [!TargetGUIDesc],edi
mov eax, dword [x]
push eax
...
mov [!TargetGUIDesc],edi
Button4_CLICK:
; LN:53 ;x=toot(1000,500)
; LN:54 call proc toot(1000,500)
mov eax,1000
push eax
mov eax,500
push eax
