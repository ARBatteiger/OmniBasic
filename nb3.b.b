...
DIM KeyTable(200) AS STRING*16
DIM KeyTableKey(200) AS LONG
DIM UMFlag AS BYTE
...
LastKey=KeyNdx
KeyTable(KeyNdx)=TempStr
TempInt=0
SETVEC KeyStringArray=ADDR(TempStr)
FOR I=1 TO LEN(TempStr)
	TempInt=TempInt+KeyStringArray(I)
NEXT I
KeyTableKey(KeyNdx)=TempInt
GOTO InitKeyWords
...
IF KeyNdx=LastKey THEN
	...
	RETURN
ENDIF
IF KeyTableKey(KeyNdx)<>TempInt THEN LookUp1
IF KeyTable(KeyNdx)=TokenBuf THEN
	RETURN
ENDIF
GOTO LookUp1
