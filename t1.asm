...
; LN:2 dim timer1 as timer
; LN:3 dim timer2(10) as timer
; LN:4 dim timer3 as timer
_StrConst1 db "timer2(3)",0
_StrConst2 db "timer2(4)",0
_StrConst3 db "timer1",0
!ObjectCount dd 5
...
!OBMain rd 192
; LN:5 dim b1 as button
!b1 rd 192
; LN:6 dim b2 as button
!b2 rd 192
; LN:7 dim b3 as button
!b3 rd 192
; LN:8 dim l1 as statictext
!l1 rd 192
...
OBMain_CREATE:
; LN:11 construct b1,10,10,80,20
mov edi,!b1
mov [!TargetGUIDesc],edi
mov eax,10
...
invoke CreateWindowEx,0,!ControlType2,NULL,$50000001, dword [edi+LeftOffs], dword [edi+TopOffs], dword [edi+WidthOffs], dword [edi+HeightOffs], dword [!OBMain],101,[!hinstance],!b1
...
; LN:13 construct b2,100,10,80,20
mov edi,!b2
mov [!TargetGUIDesc],edi
mov eax,100
mov dword [edi+LeftOffs],eax
...
jc _Lbl2
call __SetRightBottom
invoke CreateWindowEx,0,!ControlType2,NULL,$50000001, dword [edi+LeftOffs], dword [edi+TopOffs], dword [edi+WidthOffs], dword [edi+HeightOffs], dword [!OBMain],102,[!hinstance],!b2
mov dword edi,[!TargetGUIDesc]
mov dword [edi+HandleOffs],eax
invoke SetWindowLong, dword eax,GWL_USERDATA,edi
mov dword edi,[!TargetGUIDesc]
...
mov [_TmpVec1+8],0
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_TmpVec1]
; LN:15 construct b3,190,10,80,20
mov edi,!b3
mov [!TargetGUIDesc],edi
mov eax,190
mov dword [edi+LeftOffs],eax
...
jc _Lbl3
call __SetRightBottom
invoke CreateWindowEx,0,!ControlType2,NULL,$50000001, dword [edi+LeftOffs], dword [edi+TopOffs], dword [edi+WidthOffs], dword [edi+HeightOffs], dword [!OBMain],103,[!hinstance],!b3
mov dword edi,[!TargetGUIDesc]
mov dword [edi+HandleOffs],eax
invoke SetWindowLong, dword eax,GWL_USERDATA,edi
mov dword edi,[!TargetGUIDesc]
...
mov [_TmpVec1+8],0
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_TmpVec1]
; LN:17 construct l1,10,40,80,20
mov edi,!l1
mov [!TargetGUIDesc],edi
mov eax,10
mov dword [edi+LeftOffs],eax
...
jc _Lbl4
call __SetRightBottom
invoke CreateWindowEx,0,!ControlType26,NULL,$50000101, dword [edi+LeftOffs], dword [edi+TopOffs], dword [edi+WidthOffs], dword [edi+HeightOffs], dword [!OBMain],104,[!hinstance],!l1
mov dword edi,[!TargetGUIDesc]
mov dword [edi+HandleOffs],eax
invoke SetWindowLong, dword eax,GWL_USERDATA,edi
mov dword edi,[!TargetGUIDesc]
...
mov [!Timer+4],timer1_timer
mov ecx,10
mov esi,!Timer+8
_Lbl5:
mov dword [esi],timer2_timer
add esi,4
dec ecx
jne _Lbl5
mov [!Timer+48],timer3_timer
ret
; End of Init Section
