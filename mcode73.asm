...
3AC4
     ...
     $3AB3; Backward Link
A/DStatusrefx:
3AD0 GetVar; Processing Routine Token
     A/DStatus
...
3B76
     ...
     $3B68; Backward Link
GAINexprefx:
3B80 GetVar; Processing Routine Token
     $0ECC
...
3BAE
     ...
     $3BA2; Backward Link
REFchanexec:
3BB8 GetVar; Processing Routine Token
     $0090
...
3BBC
     ...
     $3BAE; Backward Link
SIGchanrefx:
3BC6 GetVar; Processing Routine Token
     $0050
