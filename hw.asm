...
!OBMain rd 192
; LN:1 DIM HelloSign AS STATICTEXT
!HelloSign rd 192
...
OBMain_create:
; LN:4 SET POSITION OBMain,40,40,100,50
mov edi,!OBMain
mov [!TargetGUIDesc],edi
mov eax,40
...
; LN:5 CREATE HelloSign,5,5,80,80
mov edi,!HelloSign
mov [!TargetGUIDesc],edi
mov eax,5
mov dword [edi+LeftOffs],eax
...
jc _Lbl1
call __SetRightBottom
invoke CreateWindowEx,0,!ControlType26,NULL,$50000101, dword [edi+LeftOffs], dword [edi+TopOffs], dword [edi+WidthOffs], dword [edi+HeightOffs], dword [!OBMain],101,[!hinstance],0
...
_Lbl1:
; LN:6 HelloSign.text="Hello World"
mov edi,!HelloSign
mov [!TargetGUIDesc],edi
mov esi,_StrConst1
mov [_TmpVec1],esi
