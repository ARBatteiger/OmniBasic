...
; LN:2 dim sv as string*2 vector
align 4
sv dd 0
 dd 2
 dd 0
; LN:3 dim ts as string
align 4
ts dd ts+12
 dd 255
 dd 0
...
;Temporary Vector
_TmpVec1 rd 3
; LN:5 DIM OBLogFont AS LOGFONT
align 4
OBLogFont rb 60
align 4
; LN:5 DIM OBFont AS FONT
OBFont rd 1
...
!OBMain rd 192
; LN:5 DIM Button1 AS BUTTON
!Button1 rd 192
; LN:5 DIM TextBox1 AS TEXTBOX
!TextBox1 rd 192
...
; LN:4 declare fcn sf1(string) as string
; LN:5 OBMain.CREATE
mov edi,!OBMain
mov [!TargetGUIDesc],edi
OBMain_CREATE:
; LN:5 SETPOSITION OBMain,340,150,640,480
mov edi,!OBMain
mov [!TargetGUIDesc],edi
mov eax,340
...
; LN:5 CREATE Button1,20,50,90,20
mov edi,!Button1
mov [!TargetGUIDesc],edi
mov eax,20
mov dword [edi+LeftOffs],eax
...
mov edi,[!TargetGUIDesc]
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_IOBuffer]
; LN:5 CREATE TextBox1,20,10,90,20
mov edi,!TextBox1
mov [!TargetGUIDesc],edi
mov eax,20
mov dword [edi+LeftOffs],eax
...
mov [_ArgSafe3],0
call __SetRightBottom
invoke CreateWindowEx,WS_EX_CLIENTEDGE,!ControlType5,NULL,$50000000, dword [edi+LeftOffs], dword [edi+TopOffs], dword [edi+WidthOffs], dword [edi+HeightOffs], dword [!OBMain],102,[!hinstance],0
mov dword [edi+HandleOffs],eax
invoke SetWindowLong, dword eax,GWL_USERDATA,edi
mov dword [edi+TTcbSizeOffs],44
mov eax,[_ArgSafe3]
...
mov edi,[!TargetGUIDesc]
invoke SendMessage, dword [edi+HandleOffs],WM_SETTEXT,0,[_IOBuffer]
; LN:5 TextBox1.BACKCOLOR=$ffffff
mov edi,!TextBox1
mov [!TargetGUIDesc],edi
mov eax,16777215
